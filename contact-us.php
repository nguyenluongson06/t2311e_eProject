            ...
            <div class="container">
                <div class="row justify-content-md-center">
                    <div class="col-12 col-md-10 col-lg-8 col-xl-7 col-xxl-6">
                        <p class="text-dark mb-5 text-center lead fs-4">Our team is available to provide prompt
                            and
                                        ...
                                        <div class="row align-items-lg-center justify-content-center h-100">
                                            <div class="col-11 col-xl-10">
                                                <div class="contact-info-wrapper py-4 py-xl-5">
                                                    <h2 class="h1 mb-3 text-dark">Get in touch</h2>
                                                    <p class="lead fs-4 text-dark opacity-75 mb-4 mb-xxl-5">We're
                                                        excited to help you find the perfect card for any occasion.
                                                        If
                                                        you have any questions or need assistance, please reach out
                                                        to
                                                        us through one of the following methods. We're here to make
                                                        your
                                                        card shopping experience as delightful as possible.
                                                    </p>
                                                    <div class="d-flex mb-4 mb-xxl-5">
                                                        ...
                                                        <div>
                                                            ...
                                                            <address class="mb-0 text-dark opacity-75">8 Ton That
                                                                Thuyet, Dich Vong, Cau Giay, Hanoi, Vietnam
                                                            </address>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="d-flex">
                                                        ...
                                                        <div>
                                                            ...
                                                            <div class="d-flex mb-1">
                                                                <p class="text-dark fw-bold mb-0 me-5">Mon - Fri
                                                                </p>
                                                                <p class="text-dark opacity-75 mb-0">9am - 5pm</p>
                                                            </div>
                                                            <div class="d-flex">
                                                                <p class="text-dark fw-bold mb-0 me-5">Sat - Sun
                                                                </p>
                                                                <p class="text-dark opacity-75 mb-0">9am - 2pm</p>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="d-flex mt-5 mb-4 mb-xxl-5">
                                                        <iframe 
