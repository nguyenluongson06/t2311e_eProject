...
$manufacturer_detail = get_manufacturer_detail($manufacturer_id);
$cards = get_card_in_manufacturer($manufacturer_id);
?>
<!DOCTYPE html>
<html lang="en">
    ...
    <body>
        ...
        <main class="main">
            <div class="container">
                <h1>Showing cards from <?php echo $manufacturer_detail["name"] ?> manufacturer</h1>
                <div class="row">
